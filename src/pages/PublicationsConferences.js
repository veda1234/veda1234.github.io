...
import Publication from '../assets/Documents/Publication.pdf'
...
function PubConPage(props){
    ...
    return(
        ...
        <HeroPage title={props.title}/>
            <AllContent>
            <ol>
            <li><a href={Publication} target='_blank' rel='noopener noreferrer'>Yadav, P. K., Birla, S., Baliga, V., Liedl, R. Chahar, B. R., and Werth, C., Contamination Assessment and 
